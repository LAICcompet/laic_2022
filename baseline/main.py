...
if __name__=="__main__":
    ...
    parser.add_argument("--do_predict", default=False, help="Whether to run predictions on the test set.")
    parser.add_argument('--device', default="4", help="Select which device to train model, defaults to gpu.")
    parser.add_argument("--test_file", default="./input/test.json", help="Whether to run training.")
