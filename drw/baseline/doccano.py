...
if __name__ == "__main__":
    ...
    parser.add_argument("--doccano_file", default="../样本/ner", type=str, help="The doccano file exported from doccano platform.")
    ...
    # 案件要素二分类
    filenames = os.listdir('../样本/案件要素')
    for filename in filenames:
        promat = filename
        doccano_file = os.path.join('../样本/案件要素', filename)
        print(doccano_file)
        options = ['正','负']
        parser = argparse.ArgumentParser()
    ...
    # 刑档多分类
    promat = '刑档'
    doccano_file = os.path.join('../样本/刑档')
    print(doccano_file)
    options = ['一档','二档','三档']
    parser = argparse.ArgumentParser()
    parser.add_argument("--doccano_file", default=doccano_file, type=str, help="The doccano file exported from doccano platform.")
